...
#define CODE_4B6B_IDLE1      (uint8_t)56
#define CODE_4B6B_IDLE2      (uint8_t)07
#define CODE_4B6B_PRE1       (uint8_t)52
#define CODE_4B6B_PRE2       (uint8_t)11
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
uint16_t convertFrom8To16(uint8_t dataFirst, uint8_t dataSecond);
uint8_t *convertFrom16To4(uint16_t dataAll);
uint8_t encode4b6b(uint8_t value);
void appendBit(uint8_t bit, uint8_t * buff);
